...
### Chinese Political History (sources in their original language)
...
### Multi-Agent Systems & Organizational Theory
...
Full reference list (with per-regime citations): see [Related Work](./README.md#10-related-work) in the README
