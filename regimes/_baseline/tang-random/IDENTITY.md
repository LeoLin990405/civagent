...
```mermaid
graph TD
    menxia -->|command| xingbu
    menxia -->|info| gongbu
    shangshu -->|command| gongbu
    shangshu -->|command| zhongshu
    hubu -->|info| zhongshu
    hubu -->|command| libu_personnel
    bingbu -->|command| libu_personnel
    libu_ritual -->|command| bingbu
    xingbu -->|command| hubu
    xingbu -->|command| shangshu
    libu_ritual -->|info| shangshu
    menxia -->|info| shangshu
    libu_ritual -->|info| gongbu
    libu_personnel -->|info| zhongshu
    hubu -->|info| libu_ritual
```
...
- `shangshu` directs `zhongshu`.
- `hubu` is kept informed by `zhongshu`.
- `hubu` directs `libu_personnel`.
- `bingbu` directs `libu_personnel`.
- `libu_ritual` directs `bingbu`.
- `xingbu` directs `hubu`.
- `xingbu` directs `shangshu`.
- `libu_ritual` is kept informed by `shangshu`.
- `menxia` is kept informed by `shangshu`.
- `libu_ritual` is kept informed by `gongbu`.
- `libu_personnel` is kept informed by `zhongshu`.
- `hubu` is kept informed by `libu_ritual`.
